...
{
    public class DataIngestion : IClassFixture<SitecoreTestFixture>
    {
        private readonly SitecoreTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(SitecoreTestFixture fixture, ITestOutputHelper output)
        {
